...
<p align="center">
  <strong>让 AI Agent 和脚本通过简单 CLI 控制你的本地浏览器——会话、Cookie 和凭证始终保留在本地。</strong>
</p>
...
> **一句话介绍：** Browser Bridge 把 Chrome 扩展与 WebSocket 中继连接起来，让任何 LLM、脚本或终端命令都能像人一样操作真实浏览器——同时把你的会话、Cookie 和凭证保留在本地。
