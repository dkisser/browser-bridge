// Package service implements the `bridge service` lifecycle commands: the Go
// port of install/bridge.sh.tmpl. Semantics, messages, and exit codes follow
// the bash implementation; the macOS supervisor design is documented in
