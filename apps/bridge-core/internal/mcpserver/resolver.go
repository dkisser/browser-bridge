...
func resolveBrowser(explicit string, browsers []protocol.BrowserConnection) (browserID, failureMessage string) {
	if explicit != "" {
...
func formatBrowserList(browsers []protocol.BrowserConnection) string {
...
func (s *Server) resolveTargetBrowser(sessionID string) (browserID, failureMessage string) {
