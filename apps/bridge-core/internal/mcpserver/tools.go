...
func (s *Server) commandTimeout(timeoutMS *int) time.Duration {
	if timeoutMS != nil {
...
func (s *Server) dispatch(ctx context.Context, req *mcp.CallToolRequest, toolName, command string, params map[string]any, timeoutMS *int, errFallback string) (protocol.ResponsePayload, *mcp.CallToolResult) {
	browserID, failure := s.resolveTargetBrowser(sessionID(req))
	if failure != "" {
		return protocol.ResponsePayload{}, toolError(toolName, failure)
	}
	result, err := s.sendCommand(ctx, browserID, command, params, s.commandTimeout(timeoutMS))
	if err != nil {
		return protocol.ResponsePayload{}, toolError(toolName, err.Error())
	}
	result = withRecoveryHint(result)
	if result.Status != "ok" {
		return protocol.ResponsePayload{}, toolError(toolName, commandErrorMessage(result, errFallback))
	}
	return result, nil
}
...
func (s *Server) runMessageTool(ctx context.Context, req *mcp.CallToolRequest, toolName, command string, params map[string]any, timeoutMS *int, errFallback, okFallback string) (*mcp.CallToolResult, any, error) {
...
func (s *Server) sendCommand(ctx context.Context, browserID, command string, params map[string]any, timeout time.Duration) (protocol.ResponsePayload, error) {
...
func (s *Server) executeListBrowsers(_ context.Context, _ *mcp.CallToolRequest, _ timeoutOnlyArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeSetBrowser(_ context.Context, req *mcp.CallToolRequest, args setBrowserArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeNavigate(ctx context.Context, req *mcp.CallToolRequest, args navigateArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeGoBack(ctx context.Context, req *mcp.CallToolRequest, args tabIDTimeoutArgs) (*mcp.CallToolResult, any, error) {
	return s.runMessageTool(ctx, req, "go_back", "goBack",
		map[string]any{"tabId": args.TabID},
		args.TimeoutMS, "Go back failed", "Went back")
}

func (s *Server) executeGoForward(ctx context.Context, req *mcp.CallToolRequest, args tabIDTimeoutArgs) (*mcp.CallToolResult, any, error) {
	return s.runMessageTool(ctx, req, "go_forward", "goForward",
		map[string]any{"tabId": args.TabID},
		args.TimeoutMS, "Go forward failed", "Went forward")
}

func (s *Server) executeRefresh(ctx context.Context, req *mcp.CallToolRequest, args tabIDTimeoutArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeTabNew(ctx context.Context, req *mcp.CallToolRequest, args tabNewArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeTabClose(ctx context.Context, req *mcp.CallToolRequest, args tabIDTimeoutArgs) (*mcp.CallToolResult, any, error) {
	return s.runMessageTool(ctx, req, "tab_close", "tab:close",
		map[string]any{"tabId": args.TabID},
		args.TimeoutMS, "tab:close failed", fmt.Sprintf("Tab %d closed", args.TabID))
}

func (s *Server) executeTabSwitch(ctx context.Context, req *mcp.CallToolRequest, args tabIDTimeoutArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeClick(ctx context.Context, req *mcp.CallToolRequest, args selectorTabArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeType(ctx context.Context, req *mcp.CallToolRequest, args typeArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeSelect(ctx context.Context, req *mcp.CallToolRequest, args selectArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeScroll(ctx context.Context, req *mcp.CallToolRequest, args scrollArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeHover(ctx context.Context, req *mcp.CallToolRequest, args selectorTabArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeWaitElement(ctx context.Context, req *mcp.CallToolRequest, args selectorTabArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeWaitNavigation(ctx context.Context, req *mcp.CallToolRequest, args tabIDTimeoutArgs) (*mcp.CallToolResult, any, error) {
	timeout := s.commandTimeout(args.TimeoutMS)
