...
func (s *Server) executePageinfo(ctx context.Context, req *mcp.CallToolRequest, args tabIDTimeoutArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeTabList(ctx context.Context, req *mcp.CallToolRequest, args timeoutOnlyArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeGettext(ctx context.Context, req *mcp.CallToolRequest, args selectorTabArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeGethtml(ctx context.Context, req *mcp.CallToolRequest, args selectorTabArgs) (*mcp.CallToolResult, any, error) {
...
func (s *Server) executeSnapshot(ctx context.Context, req *mcp.CallToolRequest, args snapshotArgs) (*mcp.CallToolResult, any, error) {
	filter := "interactive"
	if args.Filter != nil {
		filter = *args.Filter
	}
...
func (s *Server) executeScreenshot(ctx context.Context, req *mcp.CallToolRequest, args screenshotArgs) (*mcp.CallToolResult, any, error) {
